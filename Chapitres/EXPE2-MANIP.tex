...
\chapter{Résultats}
	...
	\par De même que précédemment, tous les résultats numériques (moyennes et écarts-types) relatif aux modalités dans le casque sont résumés en Table \ref{tab:resultats_casque_latence}.
	...
	\par The immersion tendency questionnaire (Fig. \ref{fig:itq_pq}) gave back an average value of $44.58$ out of $70$ (standard-deviation: $\sigma = 8.81$)
	...
	\par + non perception de son corps dans le casque
