\chapter{Indices de vision}
	...
	\begin{table}[h]
		\centering
		\caption{Acuité de l'œil}{Valeurs tirées de \citep{gross_human_2008}}
		\label{tab:acuity}
		\small
		\begin{tabular}{ll}
