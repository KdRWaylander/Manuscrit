...
%Ici c'est le positionnement de l'encadré en bas à droite
	\put(-20,80){% c'est le point bas droite
...
% Titre du manuscrit
\title{\textsc{Immersion visuelle réaliste: proposition d'un modèle d'évaluation}}

% Ecole doctorale
\ED{{\fontfamily{bch}\selectfont \'{E}cole doctorale \no 432 : Sciences des Métiers de l'Ingénieur}}

% Affiliation doctorat
...
% JURY
% Président
\jurya{M. Philippe \textsc{Fuchs}}{\hspace{1.5cm} Professeur, Mines ParisTech \hspace{1.5cm}}{Président}

% Rapporteurs
\juryb{M. Daniel R. \textsc{Mestre}}{\hspace{1.5cm} Professeur, CRVM (CNRS) \hspace{1.5cm}}{Rapporteur}
\juryc{M. Ronan \textsc{Querrec}}{\hspace{1.5cm} Professeur, ENIB \hspace{1.5cm}}{Rapporteur}

% Examinateur(s)
\juryd{Mme Pascaline \textsc{Neveu}}{\hspace{1.5cm} Docteur, IRBA \hspace{1.5cm}}{Examinatrice}
\jurye{M. David \textsc{Alleysson}}{\hspace{1.5cm} Docteur, LPNC (CNRS) \hspace{1.5cm}}{Examinateur}

% Encadrants
\juryf{M. Andras \textsc{Kemeny}}{\hspace{1.5cm} Professeur, Arts \& Métiers \hspace{1.5cm}}{Examinateur}
\juryg{M. Frédéric \textsc{Merienne}}{\hspace{1.5cm} Professeur, Arts \& Métiers \hspace{1.5cm}}{Examinateur}
\juryh{M. Stéphane \textsc{Régnier}}{\hspace{1.5cm} Ingénieur, Renaut S.A.S. \hspace{1.5cm}}{Invité}
